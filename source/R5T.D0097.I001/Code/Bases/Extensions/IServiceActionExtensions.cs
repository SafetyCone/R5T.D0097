...
namespace R5T.D0097.I001
{
    ...
    {
        /// <summary>
        /// Adds the <see cref="TypeBasedJsonReserializer{TBase}"/> implementation of <see cref="ITypeBasedJsonReserializer{TBase}"/> as a <see cref="Microsoft.Extensions.DependencyInjection.ServiceLifetime.Singleton"/>.
